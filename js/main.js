...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function renderHero() {
            ...
            if (title && !title.querySelector('img')) title.innerHTML = '<span class="la">' + escapeHtml((h.titulo1 || dh.titulo1 || 'la').toLowerCase()) + '</span><em>' + escapeHtml(h.tituloEm || dh.tituloEm || 'MIF') + '</em>';
